  ...
  <section class="home-section">
    <nav>
      <div class="sidebar-button">
        ...
        <span class="dashboard">รายงานสถิติรายวัน</span>
      </div>
    </nav>
      ...
      <div class="overview-boxes">
        <div class="box">
          <div class="right-side">
            <div class="box-topic">จำนวนการขออนุญาตของวันที่ <?php echo $date; ?></div>
        ...
        <div class="box">
          <div class="right-side">
            <div class="box-topic">จำนวนแผนกที่มีนักศึกษาขออนุญาต <?php echo $date; ?></div>
