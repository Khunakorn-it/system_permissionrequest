        ...
        <div class="overview-boxes">
          <div class="box">
            <div class="right-side">
                <h2>เพิ่มข้อมูลระดับชั้น</h2>
                <form action="save_gradelevel.php" method="post">
                    <div class="form-group">
                        <label for="usr">ชื่อระดับชั้น</label>
                        <input type="text" class="form-control" id="usr" name="g_name">
                    </div>
