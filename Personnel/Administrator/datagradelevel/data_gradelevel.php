        ...
        <div class="overview-boxes">
          <div class="box">
            <div class="right-side">
              <a href="add_gradelevel.php" class="btn btn-success" ><i class='bx bx-message-square-add'></i> เพิ่มข้อมูล</a>
                ...
                <table class="table table-hover">
                  ...
                  <tbody id="myTable">
                      ...
                      <tr>
                          ...
                          <td>
                              <div class="btn-group">
                                  <a href="edit_gradelevel.php?id=<?php echo $row['id_gradelevel'];?>" class="btn btn-primary"><i class='far fa-edit'></i> แก้ไข</a>
                                  <a href="delete_gradelevel.php?id=<?php echo $row['id_gradelevel']; ?>" class="btn btn-danger" onclick="return confirm('Are your Sure to Delete')"><i class="far fa-trash-alt"></i> ลบ</a>
                              </div>
                          </td>
                      </tr>
                      <?php endwhile ?>
