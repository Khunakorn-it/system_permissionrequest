...
<?php //เชื่อมdatabase
    ...
    $sql = "SELECT * FROM `tb_personnel_join`";
    $result = mysqli_query($con,$sql);
    $num = mysqli_num_rows($result);
?>
    <div class="container-fluid mt-3">
        <h1 class="textcenter">ข้อมูลบุคลากร</h1>
                ...
                <tr>
                    ...
                    <td>
                        <div class="btn-group">
                            ...
                            <a href="delete_personnel.php?id=<?php echo $row['id_personnel']; ?>" class="btn btn-danger" onclick="return confirm('Are your Sure to Delete')">ลบ</a>
                        </div>
                    </td>
                </tr>
                <?php endwhile ?>
