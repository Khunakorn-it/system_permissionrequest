    ...
    <section class="home-section">
      <nav>
        <div class="sidebar-button">
          ...
          <span class="dashboard">จัดการข้อมูลตำแหน่ง</span>
        </div>
      </nav>
            ...
            <div class="right-side">
                ...
                <form action="update_position.php" method="post">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="usr" name="p_name" value="<?php echo $row['p_name'] ;?>">
                    </div>
                    <button type="submit" class="btn btn-primary"><i class='bx bx-save' ></i> บันทึก</button>
                    <a href="data_position.php" class="btn btn-danger"><i class='bx bx-x' ></i> ยกเลิก</a>
                        <input type="hidden" name="id_position" value="<?php echo $_GET['id'];?>">
                </form>
            </div>
          </div>
        </div>
