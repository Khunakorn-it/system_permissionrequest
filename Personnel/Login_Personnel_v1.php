        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="alert alert-info">
                    <h1 class="text-center">บุคลากร</h1>
                    <form action="chklogin_Personnel.php" method="post">
                        <div class="form-group">
                            <label>รหัสประจำตัวบุคลากร</label>
                            <input type="text" class="form-control" id="id_personnel" placeholder="" name="id_personnel">
                        </div>
                        <div class="form-group">
                            <label for="pwd">รหัสผ่าน</label>
                            <input type="password" class="form-control" id="p_password" placeholder="" name="p_password">
                        </div>
