                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-group">
                                    ...
                                    <a href="delete_personnel.php?id=<?php echo $row['id_personnel']; ?>" class="btn btn-danger" onclick="return confirm('คุณต้องการลบใช่หรือไม')"><i class="far fa-trash-alt"></i> ลบ</a>
                                </div>
                            </td>
                        </tr>
                        <?php endwhile ?>
