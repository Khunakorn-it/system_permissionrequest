                    ...
                    <tbody id="myTable">
                        <?php while($row_request = $result_request->fetch_assoc()):?>
                            <tr>
                                ...
                                <td>
                                  <div class="btn-group">
                                    <a href="edit_status.php?id_request=<?php echo $row_request['id_request'];?>&status=2&Location=view_student_request.php" class="btn btn-success"><i class='bx bx-check'></i> อนุมัติ</a>
                                    <a href="edit_status.php?id_request=<?php echo $row_request['id_request'];?>&status=3&Location=view_student_request.php" class="btn btn-danger"><i class='bx bx-x'></i> ไม่อนุมัติ</a>
