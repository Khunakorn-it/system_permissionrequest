	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form" action="../chklogin_Student.php" method="post">
					<span class="login100-form-title">
						กลุ่มนักศึกษา
					</span>

					<div class="wrap-input100 validate-input" data-validate = "คุณยังไม่ป้อนรหัสประจำตัว">
						<input class="input100" type="text" name="id_student" placeholder="รหัสประจำตัว">
					...
					<div class="wrap-input100 validate-input" data-validate = "คุณยังไม่ป้อนรหัสผ่าน">
						<input class="input100" type="password" name="s_password" placeholder="รหัสผ่าน">
						<span class="focus-input100"></span>
						<span class="symbol-input100">
